...
<form method="post" action="${pageContext.request.contextPath}/admin/add_user" modelAttribute="userToAdd">
    ...
    <div class="input-container ic2">
        <input id="password" class="input" type="password" placeholder=" " name="password" onkeyup='checkInput();' required/>
        <div class="cut"><div class="cutPassword"></div></div>
        <label for="password" class="placeholder">Password</label>
    </div>

    <div class="input-container ic2">
        <input id="confirm_password" class="input"  type="password" name="confirm_password"  onkeyup='checkInput();'  placeholder=" " required/>
